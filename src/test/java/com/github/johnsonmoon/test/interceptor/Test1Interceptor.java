 ...
 */
@Intercept(targetClass = "com.github.johnsonmoon.test.obj.TestObject", targetMethod = "test1")
public class Test1Interceptor implements Interceptor {
    private static Logger logger = LoggerFactory.getLogger(Test1Interceptor.class);

    @Override
    public void before(Object[] params) {
        logger.info("Before, interceptor {}, params {}", 1, params);
    }

    @Override
    public void after(Object[] params, Object retValue) {
        logger.info("After, interceptor {}, params {}, retValue {}", 1, params, retValue);
    }

    @Override
    public void afterThrow(Object[] params, Throwable e) {
        logger.info("After throw, interceptor {}, params {}, throwable {}, throwable message: {}", 2, params, e, e.getMessage());
    }
}
