 ...
 */
@Intercept(targetClass = "com.github.johnsonmoon.test.obj.TestObject", targetMethod = "test2")
public class Test2Interceptor implements Interceptor {
    private static Logger logger = LoggerFactory.getLogger(Test2Interceptor.class);

    @Override
    public void before(Object[] params) {
        logger.info("Before, interceptor {}, params {}", 2, params);
    }

    @Override
    public void after(Object[] params, Object retValue) {
        logger.info("After, interceptor {}, params {}, retValue {}", 2, params, retValue);
    }
